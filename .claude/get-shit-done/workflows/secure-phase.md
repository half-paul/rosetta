...
```
Task(
  prompt="Read /Users/paul/Documents/development/ai-projects/projects/gsd/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/paul/Documents/development/ai-projects/projects/gsd/.claude/get-shit-done/templates/SECURITY.md`
