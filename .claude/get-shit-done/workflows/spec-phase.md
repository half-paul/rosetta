...
```bash
INIT=$(node "/Users/paul/Documents/development/ai-projects/projects/gsd/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/paul/Documents/development/ai-projects/projects/gsd/.claude/get-shit-done/templates/spec.md.
